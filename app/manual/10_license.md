...
*	[General Terms and Conditions](@ref general_terms)
*	[Mozilla Public License Version 2.0](@ref mpl2_license)
*	[Third Party Libraries](@ref third_party_libraries)

General Terms and Conditions {#general_terms}
=======================

NAP Framework is open source software, licensed under the: Mozilla Public  License, version 2.0. You can obtain the NAP source code at: https://github.com/napframework/nap. You can use the NAP source code and NAP distributable package to create both commercial and non-commercial derivate works, as long as the MPL 2.0 license is not violated. 
...
Mozilla Public License Version 2.0 {#mpl2_license}
=======================
...
The Software is designed to let you work with the following libraries (hereinafter: “Third Party Libraries”). These libraries are owned and operated by other entities with their own terms and provisions, which you can find here:
...
If you have a question regarding the use of any of these Third Party Libraries, contact the Third Party Library itself. Third Party Libraries are often tied to a specific module, by not including the module you will not include the library. `rapidjson`, `python` and `rttr` are notable exceptions. They are included in every project, as a dependency of the NAP core library.